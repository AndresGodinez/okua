<?php $this->layout("/layouts/session-default", ["title" => 'Edición Usuario']); ?>
...
<link rel="stylesheet" href="/css/catalogs-user-form.css">
...
<script src="/js/user-form.js" type="application/javascript"></script>