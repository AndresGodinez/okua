<?php $this->layout("/layouts/session-default", ["title" => 'Edición respuesta de alerta']); ?>
...
<link rel="stylesheet" href="/css/catalogs-alert-email-response-form.css">
...
<script src="/js/alert-email-response-form.js" type="application/javascript"></script>