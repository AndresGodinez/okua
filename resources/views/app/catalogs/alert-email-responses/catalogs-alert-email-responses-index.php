<?php $this->layout("/layouts/session-default", ["title" => 'Respuestas de alertas']); ?>

<?=$this->start('styles-content')?>
<link rel="stylesheet" href="/css/catalogs-alert-email-responses-index.css">
...
<script src="/js/alert-email-responses-index.js" type="application/javascript"></script>