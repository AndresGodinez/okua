 ...
 * @package App\Models
 */
class GetFilteredWarningRegistersCountRequestData implements IValidableRequest
{
    /**
     * @param $data
    ...
    public static function makeFromArray($data)
    {
        ...
        $inst = new GetFilteredWarningRegistersCountRequestData($startDatetime, $endDatetime, $filterDateType);
