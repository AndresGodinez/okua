 ...
 * @package App\Models
 */
class GetFilteredBillInfoReportData implements IValidableRequest
{
    /**
     * @param $data
     * @return GetFilteredBillInfoReportData
     */
    public static function makeFromArray($data)
    {
        ...
        $inst = new GetFilteredBillInfoReportData($startDatetime, $endDatetime, $filterDateType);
