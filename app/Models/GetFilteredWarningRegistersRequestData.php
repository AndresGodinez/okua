 ...
 * @package App\Models
 */
class GetFilteredWarningRegistersRequestData implements IValidableRequest
{
    /**
     * @param $data
    ...
    public static function makeFromArray($data)
    {
        ...
        $inst = new GetFilteredWarningRegistersRequestData($limit, $offset, $startDatetime, $endDatetime, $filterDateType);
