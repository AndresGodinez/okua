...
class GetBillsTotalApiViewTest extends TestCase
{
    ...
    public function testFilterByWeek()
    {
        ...
        try {
            $register = self::$fm->instance(BillInfo::class, ['type' => 'I', 'transferTaxes' => 500, 'emailDatetime' => $now]);
    ...
    public function testFilterByMonth()
    {
        ...
        try {
            ...
            $register = self::$fm->instance(BillInfo::class, ['type' => 'I', 'transferTaxes' => 500, 'emailDatetime' => $pastMonth]);
            self::$em->persist($register);
    ...
    public function testFilterByYear()
    {
        ...
        self::$em->beginTransaction();
        try {
            $register = self::$fm->instance(BillInfo::class, ['type' => 'I', 'transferTaxes' => 100, 'emailDatetime' => $now]);
            self::$em->persist($register);
            ...
            $register = self::$fm->instance(BillInfo::class, ['type' => 'I', 'transferTaxes' => 500, 'emailDatetime' => $pastDatetime]);
            self::$em->persist($register);
