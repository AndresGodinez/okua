...
/**
 * Class FilterReceptorEntityTest
 * @package Tests\Entities
 */
class FilterReceptorEntityTest extends TestCase
{
    /** @var Container */
    ...
    public static function setUpBeforeClass()/* The :void return type declaration that should be here would cause a BC issue */
    {
        ...
        $metadata = self::$em->getClassMetadata(FilterReceptor::class);
    ...
    {
        $register = self::$fm->instance(FilterReceptor::class);
    ...
    public function testErrorNullRfc()
    {
        ...
        $register = self::$fm->instance(FilterReceptor::class, ['rfc' => null]);
        self::$em->persist($register);
        self::$em->flush();
    }
    ...
    public function testErrorSameRfc()
    {
        ...
        $register = self::$fm->instance(FilterReceptor::class, ['rfc' => 'CTS140515S7A']);
        self::$em->persist($register);
        self::$em->flush();
