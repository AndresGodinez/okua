...
/**
 * Class TmpEmitterEntityTest
 * @package Tests\Entities
 */
class TmpEmitterEntityTest extends TestCase
{
    /** @var Container */
    ...
    public static function setUpBeforeClass()/* The :void return type declaration that should be here would cause a BC issue */
    {
        ...
        $metadata = self::$em->getClassMetadata(TmpEmitter::class);
    ...
    {
        $register = self::$fm->instance(TmpEmitter::class);
    ...
    public function testErrorNullName()
    {
        ...
        $register = self::$fm->instance(TmpEmitter::class, ['name' => null]);
        self::$em->persist($register);
        self::$em->flush();
    }
    ...
    public function testErrorNullRfc()
    {
        ...
        $register = self::$fm->instance(TmpEmitter::class, ['rfc' => null]);
        self::$em->persist($register);
        self::$em->flush();
    }
    ...
    public function testErrorNullEmail()
    {
        ...
        $register = self::$fm->instance(TmpEmitter::class, ['email' => null]);
        self::$em->persist($register);
        self::$em->flush();
    }
    ...
    public function testErrorSameRfc()
    {
        ...
        $register = self::$fm->instance(TmpEmitter::class, ['rfc' => 'CTS140515S7A']);
        self::$em->persist($register);
        self::$em->flush();
