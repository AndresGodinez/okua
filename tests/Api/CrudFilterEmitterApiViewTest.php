...
/**
 * Class CrudFilterEmitterApiViewTest
 * @package Tests\Api
 */
class CrudFilterEmitterApiViewTest extends TestCase
{
    const BASE_ROUTE = '/api/filter-emitter';
    ...
    public function testCreateRegisterSuccessfully()
    {
        ...
        EntityUtils::$mockedEm->expects($this->once())
            ->method('persist')
            ->with($this->isInstanceOf(FilterEmitter::class));
    ...
    public function testReadRegistersSuccessfully()
    {
        ...
        $mockedRepo = $this->createMock(FilterEmitterRepository::class);

        $mockedRegisters = [];
        \array_push($mockedRegisters, self::$fm->instance(FilterEmitter::class, ['id' => 1]));
        \array_push($mockedRegisters, self::$fm->instance(FilterEmitter::class, ['id' => 2]));
        \array_push($mockedRegisters, self::$fm->instance(FilterEmitter::class, ['id' => 3]));
        \array_push($mockedRegisters, self::$fm->instance(FilterEmitter::class, ['id' => 4]));
        \array_push($mockedRegisters, self::$fm->instance(FilterEmitter::class, ['id' => 5]));
    ...
    public function testReadRegisterSuccessfully()
    {
        ...
        $mockedRegister = self::$fm->instance(FilterEmitter::class, ['id' => 1]);
    ...
    public function testDeleteRegisterSuccessfully()
    {
        ...
        EntityUtils::$mockedEm->expects($this->once())
            ->method('find')
            ->with(FilterEmitter::class, $this->identicalTo(1))
            ->willReturn($mockedRegister);
