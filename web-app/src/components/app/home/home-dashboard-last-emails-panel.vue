<template>
    <div class="flex flex-col w-1/5 flex-no-shrink mt-4 relative max-h-full">
        ...
        <div class="w-full flex flex-col overflow-y-auto pb-4">
            <div v-for="item in lastEmailsData"
                 class="flex flex-col flex-no-shrink w-full shadow p-4 mt-2 bg-theme-color-1 hover:bg-theme-color-1-dark">
