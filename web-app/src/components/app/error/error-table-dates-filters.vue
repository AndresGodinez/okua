    ...
    <div class="inline-flex w-full mt-4">
        <div class="flex items-center mb-6">
            <div class="md:w-2/3">
                <label class="block font-bold md:text-right mb-1 md:mb-0 pr-4 text-theme-color-4-darkest"
                       for="cit-error-filter-start-date">
                    Fecha de inicio
                </label>
            </div>
            <div class="md:w-1/3">
                <datetime input-class="bg-white shadow border-2 border-grey p-2 rounded-sm"
                          v-model="startDate" type="date" id="cit-error-filter-start-date" format="yyyy-MM-dd" value-zone="America/Monterrey"
        ...
        <div class="flex items-center mb-6 ml-12">
            <div class="md:w-2/3 mr-4">
                <label class="block font-bold md:text-right mb-1 md:mb-0 pr-4 text-theme-color-4-darkest"
                       for="cit-error-filter-end-date">
                    Fecha Fin
                </label>
            </div>
            <div class="md:w-1/3">
                <datetime input-class="bg-white shadow border-2 border-grey p-2 rounded-sm -ml-4"
                          v-model="endDate" type="date" id="cit-error-filter-end-date" format="yyyy-MM-dd" value-zone="America/Monterrey"
...
<script>
  ...
  export default {
    ...
    name: 'error-table-dates-filters',
    components: {
      datetime: Datetime,
    },
  }
